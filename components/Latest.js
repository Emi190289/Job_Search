...
const Latest = () => {
  ...
  return (
    <div className='bg-[#56BC80] text-white py-10'>
      ...
      <div className='grid grid-cols-1 md:grid md:grid-cols-2 py-4  sm:py-6 sm:px-4'>
        <div className='text-center text-2xl sm:text-left  sm:text-3xl lg:text-4xl font-bold'>Latest Jobs Here</div>
        <a className='text-center sm:text-right text-lg lg:text-xl' href='/joblist'>View All Jobs</a>
      </div>
      <div className= 'grid grid-cols-1  p-4 md:grid md:grid-cols-3 gap-5'>
        {jobs && jobs.map(job => (

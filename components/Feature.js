...
const Feature = () => {
  return (
    <div className='max-w-screen-xl mx-auto my-10 sm:my-20'>
      ...
      <div className='p-4'>  <p className='text-center text-lg font-semibold mt-10'>How JOBS can help</p>
        <p className='text-center text-xs max-w-screen-sm mx-auto my-6 '>We are the largest independent job board, register your CV to apply today with simple search tool and instant job matches delivered to your inbox, it&apos;s never been easier to land a new job with us </p></div>
